...
namespace Esk8Bst.Services {
    /// <summary>
    /// A class that allows us to send signed data, and receive it back.
    /// </summary>
    public class EncryptorService {
        ...
        public static string Base64Decode(string base64EncodedData) {
            ...
            return System.Web.HttpUtility.UrlDecode(base64EncodedData);
        }

        public static string OneWayHash(string text) {
            var x = SHA256Managed.Create();
